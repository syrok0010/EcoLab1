...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnProcessStart(/* in */ struct IEcoLab1Events* me, /* in */ const void* start_ptr, /* in */ uint32_t count) {
    printf("\n[Sink 1: Logger] START sorting %d elements. Memory at %p\n", count, start_ptr);
    return 0;
}
